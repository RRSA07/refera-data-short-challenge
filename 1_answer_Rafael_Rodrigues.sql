/*Para a primeira questão foi feito o relacionamento entre as tabelas de 
  ...
  Key para a tabela de film a partir dessa relação conseguimos identificar os titulos dos 
